...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    JTextField tfname, tfemail, tfphone, tfage,  tfsalary, tfaadhaar;
    ...
    AddEmployee() {
      ...
      String str[] = {"Front Desk Clerks", "Porters", "Housekeeping", "Kitchen Staff", "Chefs", "Waiter/Waitress", "Manager", "Accountant"};
